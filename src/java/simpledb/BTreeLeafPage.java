...
public class BTreeLeafPage extends BTreePage {
	...
	public void deleteTuple(Tuple t) throws DbException {
		...
		{
			System.out.println("rid.getPageId().pageNumber(): "+Integer.toString(rid.getPageId().pageNumber()));
			System.out.println("pid.pageNumber(): "+Integer.toString(pid.pageNumber()));
			System.out.println("rid.getPageId().getTableId(): "+Integer.toString(rid.getPageId().getTableId()));
			System.out.println("pid.getTableId(): "+Integer.toString(pid.getTableId()));
